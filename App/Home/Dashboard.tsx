...
export default class Dashboard extends React.Component<{}, IState> {
    ...
    private learnMore() {
        return (
            ...
            <Modal.Body>
                <h4>Look another Modal!!!!</h4>
                <p>Lorem ipsum dolar emit mattis consectetur purus sit amet fermentum. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Morbi leo risus, porta ac consectetur ac, vestibulum at eros.</p>
